...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        Label(self, text='Encoding').grid(row=0, column=2)
        Label(self, text='Delimiter').grid(row=0, column=3)

        self.fileselect_input = FileSelect(self, 'Input file', 1)
        self.fileselect_gradebook = FileSelect(self, 'Gradebook file', 2)
